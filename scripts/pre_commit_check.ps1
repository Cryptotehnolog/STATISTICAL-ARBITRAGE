...
$costRealismPipelineCheckScript = Join-Path $PSScriptRoot "check_cost_realism_pipeline.ps1"
...
Write-Output "- Проверка capacity/cost realism pipeline: check_cost_realism_pipeline.ps1"
...
try {
    ...
    Invoke-RequiredCheck $costRealismPipelineCheckScript
